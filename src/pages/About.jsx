    ...
    <div className="about-container">
      ...
      <div className="aim">
        ...
        <p className="aim--description">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero at placeat error et ad ipsa, consequatur nesciunt nam odio provident, ex voluptatum, maiores repellat vero natus accusantium harum delectus deleniti. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aliquam excepturi facilis aspernatur officia et modi sed illo exercitationem quam tempora, assumenda eius ipsum totam eligendi harum sit facere praesentium soluta!
          Incidunt laudantium similique blanditiis! Excepturi eaque sint recusandae fugit error blanditiis deleniti neque ex quo odit sed aperiam veritatis ipsa cum, provident ab reprehenderit voluptatibus, minima sit unde! Perspiciatis, ipsum?
          Voluptate consequatur earum necessitatibus esse nisi vitae ad facilis excepturi, similique, exercitationem nobis placeat, molestiae quidem sint. Suscipit saepe nobis, cum nemo facere modi deleniti, error earum, dolorum inventore doloremque.
        </p>
      </div>
